...
| `b3_enriquecimento_cadastral_ativos` | 01/09/2026 22:00:00 | Única | Executado uma vez pelo serviço `financial-research-b3-cad.timer`. |
| `cvm_formulario_de_referencia` | 19:00:00 | Diária | Executado pelo serviço `financial-research-cvm-fre.timer`. |
