# Docker — CVM Formulario Demonstracoes Financeiras Padronizadas

Comandos Docker específicos para execução e manutenção do pipeline de Formulário de Demonstrações Financeiras Padronizadas (DFP) da CVM.
