...
class RetentionPolicyWorkerInterfaceB(RetentionPolicyWorkersInterface):
    
    
    process: str = "retention_policy_worker_b"
...
if __name__ == "__main__":
    worker = RetentionPolicyWorkerInterfaceB(pipeline="cvm_formulario_informacoes_trimestrais")
