...
**Saída:** `raw/zip/dfp_cia_aberta_{ano}.zip` → `raw/csv/dfp_cia_aberta_{demonstracao}_{ano}.csv`

**Comportamento:**
- Baixa um ZIP por ano (`dfp_cia_aberta_2011.zip` … `dfp_cia_aberta_{ano_atual}.zip`).
...
**Entrada:** `raw/csv/dfp_cia_aberta_{demonstracao}_{ano}.csv` (2011 … ano atual)  
**Saída:** `interim/dfp_cia_aberta_{demonstracao}_2011-{ano_atual}.csv`
...
**Entrada:** `interim/dfp_cia_aberta_{demonstracao}_2011-{ano_atual}.csv`  
**Saída:** `processed/transform_2/{TICKER}/{TICKER}_dfp_cia_aberta_{demonstracao}_2011-{ano_atual}.csv`
