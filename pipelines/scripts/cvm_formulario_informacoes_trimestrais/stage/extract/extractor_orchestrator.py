...
from pipelines.scripts.cvm_formulario_informacoes_trimestrais.stage.extract.extractor_worker_A import ExtractorWorkerA
from pipelines.scripts.cvm_formulario_informacoes_trimestrais.stage.extract.extractor_worker_B import ExtractorWorkerB
