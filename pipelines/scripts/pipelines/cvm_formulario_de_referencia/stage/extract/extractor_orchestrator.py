...
from pipelines.scripts.pipelines.cvm_formulario_de_referencia.stage.extract.extractor_worker_A import ExtractorWorkerA
from pipelines.scripts.pipelines.cvm_formulario_de_referencia.stage.extract.extractor_worker_B import ExtractorWorkerB
