...
from pipelines.scripts.pipelines.template.stage.extract.extractor_worker_A import ExtractorWorkerA
from pipelines.scripts.pipelines.template.stage.extract.extractor_worker_B import ExtractorWorkerB


class ExtractorOrchestrator(ExtractorOrchestratorInterface):


    process = "extractor_orchestrator"
    ...
    def build_workers(self, ctx: PipelineContext) -> list[ExtractorWorkersInterface]:
