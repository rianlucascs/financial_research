...
from pipelines.scripts.pipelines.template.stage.transform.to_processed.to_processed_worker_A import ToProcessedWorkerA


class ToProcessedOrchestrator(ToProcessedOrchestratorInterface):
    
    
    process = "to_processed_orchestrator"
    ...
    def build_workers(self, ctx: PipelineContext) -> list[ToProcessedWorkersInterface]:
