...
class ReaderHistoricalDataCVMITR(ReaderHistoricalDataInterface):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            filename=f"itr_cia_aberta_{demonstration_code}_2011-{date.today().year}_{comparation}.parquet",
            snapshot=snapshot
        )
