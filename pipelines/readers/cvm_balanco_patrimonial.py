...
from pipelines.readers.cvm_formulario_demonstracoes_financeiras_padronizadas import ReaderCVMFormularioDemonstracoesFinanceirasPadronizadas
from pipelines.readers.cvm_formulario_informacoes_trimestrais import ReaderCVMFormularioDemonstracoesFinanceirasPadronizadas

import pandas as pd


class ReaderCVMBalancoPatrimonial:
    """Classe para leitura do Balanço Patrimonial da CVM, combinando dados de ITR e DFP."""
    
    def __init__(self):
        
        self.reader_itr = ReaderCVMFormularioDemonstracoesFinanceirasPadronizadas()
        self.reader_dfp = ReaderCVMFormularioDemonstracoesFinanceirasPadronizadas()
