...
| `google_enriquecimento_cadastral_ativos` — *dev* | [Google](https://news.google.com/)                                                           | Extração e processamento de informações complementares para enriquecimento cadastral e identificação de ativos financeiros. |
